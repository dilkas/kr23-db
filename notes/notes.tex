...
TODO: explain the `tail' part of the algorithm, i.e., that the first formula is replaced by some vertices and some formulas.
...
\begin{algorithm}
  ...
  \KwIn{functions $\{\,f_l\,\}_{l \in \mathcal{T}}$ that take a list of sets of atoms and return a set of atoms}
