...
\item inequality constraint. Notation: $[x \ne y]$, where $x$ is a variable (of the clause), and $y$ is either a variable or a constant.
...
\begin{definition}
  ...
  TODO: it's probably enough to say it's a set of literals, a set of constraints, and a $\delta$.
\end{definition}
...
\begin{itemize}
\item for each clause $c = (P, N, C, \delta_c) \in \phi$ and variable $v \in \Vars(c)$, either $\delta_c(v) \ne d$ or $[v \ne e] \in C$;
