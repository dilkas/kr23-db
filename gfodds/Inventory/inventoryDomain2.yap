...
tvd(load, succ, tfull, [y1], [1], 5, [node(5,tfull(y1),1,4), node(4,tin(y1,xl),3,0), node(3,depot(xl),2,0),node(2,eq(y1,xh),1,0),node(1,1.0,-1,-1),node(0,0.0,-1,-1)]).

%%%%%%%%%%%% TVD: UNLOAD_FROM_TRUCK_IN_CITY SUCCESS %%%%%%%%%%%%%%%

tvd(unload, succ, tfull, [y2], [1], 7, [node(7,empty(xl),6,2), node(6,tfull(y2),5,0), node(5,tin(y2,xl),4,1), node(4,shop(xl),3,1),node(3,eq(y2,xh),0,1),node(2,tfull(y2),1,0),node(1,1.0,-1,-1),node(0,0.0,-1,-1)]).

tvd(unload, succ, empty, [y3], [1], 6, [node(6,empty(y3),5,0), node(5,tfull(xh),4,1), node(4,tin(xh,y3),3,1), node(3,shop(y3),2,1),node(2,eq(y3,xl),0,1),node(1,1.0,-1,-1),node(0,0.0,-1,-1)]).

%%%%%%%%%%%% TVD: DRIVE_TRUCK_FROM_CITY_TO_CITY SUCCESS %%%%%%%%%%%%%%%

tvd(drive, succ, tin, [y4,y5], [1,2], 7, [node(7,tin(y4,y5),4,6), node(6,tin(y4,xl),5,0), node(5,eq(y4,xh),2,0), node(4,eq(y4,xh),3,1), node(3,eq(y5,xl),2,1),node(2,eq(y5,xl1),1,0),node(1,1.0,-1,-1),node(0,0.0,-1,-1)]).

tvd(drive, succ, tin, [y6,y7], [2,1], 8, [node(8,tin(y6,y7),4,7), node(7,tin(y6,xl),6,0), node(6,eq(y7,xl1),5,0), node(5,eq(y6,xh),1,0), node(4,eq(y7,xl),3,1), node(3,eq(y7,xl1),1,2),node(2,eq(y6,xh),0,1),node(1,1.0,-1,-1),node(0,0.0,-1,-1)]).
