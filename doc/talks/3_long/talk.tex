...
% TODO: unify the use of colours
% TODO: do I want to mention forclift and/or crane?
% TODO: maybe replace red!50 with one of the main colours
% TODO: \color -> \textcolor everywhere
% TODO: how do we capitalise blocks?
...
\begin{frame}{What Computers Can and Cannot Do}
  ...
  \end{tikzpicture}
\end{frame}
% TODO: replace the cat thing with a funny DALL-E picture
...
% TODO: add a slide about other approaches to WFOMC, making it crystal clear
% what my contributions are. This will finish the introduction
...
% TODO: it would be good to have a similar compilation walkthrough for an instance with Ref as well
...
\begin{frame}{Back to Our Example}
  ...
  \begin{itemize}
    ...
    \item But \alert{$\Theta(mn)$} is still much better than translating to
          propositional logic and running a WMC algorithm \pause
...
% TODO: add arrows that explain the meaning/definition of each node type
...
% TODO: maybe replace the zoom picture with some galaxy picture?
...
\begin{frame}{Summary \& Future Work}
  ...
  \end{block}
\end{frame}
% TODO: for future work, come back to the 'many ways to count' slide and add
% more arrows (e.g., beyond FOL)
% TODO: also incorporate the last slide of the 4th talk
\end{document}
