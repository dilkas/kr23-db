...
\begin{frame}{Who Cares About Counting?}
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \begin{block}{Probabilistic Inference}
      \end{block}
      \begin{block}{Neuro-symbolic AI}
      \end{block}
      \begin{block}{Natural Language Processing}
      \end{block}
    \end{column}
    \begin{column}{0.5\textwidth}
      \begin{block}{Enumerative Combinatorics} % recurrence_relations2.pdf
      \end{block}
  ...
  \end{columns}
\end{frame}
% TODO: either add the remaining (bookmarked) pictures or maybe replace them with screenshots of papers (find the most cited paper in each case)
