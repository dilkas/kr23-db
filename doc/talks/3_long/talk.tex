...
% TODO: consider adding an outline slide
% TODO: add periods at the end of sentences
...
% TODO: maybe add a future <-> past picture slide
...
\begin{frame}{Algebraic Solutions to Parameterised Problems (2/2)}
  ...
  \end{itemize}
\end{frame}
% TODO: add a concluding diagram: 'reasoning with functions'(in a box) >(big) 'reasoning with numbers'
