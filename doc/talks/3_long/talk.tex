...
\begin{frame}{First-Order Knowledge Compilation: Before and After}
  ...
  \end{tikzpicture}
\end{frame}
% TODO: optimize edge lengths
% TODO: add forclift on the left, with its own example instance
% TODO: check if the math works out

% TODO: talk #4 might have some useful additions to this section
