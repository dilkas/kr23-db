...
\begin{frame}{What Computers Can and Cannot Do}
  ...
  \end{tikzpicture}
\end{frame}
% TODO: replace cat with 'Generate a picture of a monkey with a funny hat'

\begin{frame}[fragile]{Many Ways to Count}
  \begin{center}
    \begin{tikzcd}
      \WMI{} & \WFOMI{} \\
      \#\SAT{}/\WMC{} & \WFOMC{} \\
  ...
  \end{center}
\end{frame}
% maybe mention #CSP and other non-SAT ways of counting
