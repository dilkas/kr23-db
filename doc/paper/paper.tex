...
% TODO: cite the linear order axiom paper \cite{DBLP:journals/corr/abs-2211-01164} in the introduction
% TODO: introduction: move the huge footnote to the main text
...
\end{example}
% TODO: maybe add an extra sentence to explain what the formula means
