...
% TODO: Maybe some of the info from the preliminaries is redundant now that I've
% moved the proofs elsewhere?
...
% TODO (about the first sentence): say: this shows that there is no loss of
