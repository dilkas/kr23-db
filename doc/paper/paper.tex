...
\begin{figure*}[t]
  ...
  \begin{subfigure}{\textwidth}
    ...
    \caption{\textsc{Crane} compiles $\phi$ into a graph $G_{\phi}$ and then
      ...
      main function in $\mathcal{F}'_{\phi}$ with domain sizes as arguments.}
  \end{subfigure}
...
% TODO:: emphasise that the (complexity) results show Crane to be strictly more
% capable than ForcLift in a sense that it can solve everything that ForcLift
% can and more (including instances beyond C^2).
