...
% TODO: double check the first sentence and if this paragraph still makes sense
...
% The
% commutativity check also ensures that $\rho \cup \gamma$ is possible on
% \cref{line:recursion} of \cref{alg:trycache}. The resulting (partial) function
% $\rho \cup \gamma$ is the unique function s.t.
% $\rho \cup \gamma|_{\dom(\rho)} = \rho$, and
...
% TODO: rewrite to include references to the subsections?
