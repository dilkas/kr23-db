...
% TODO: emphasise that there are two parts: search (with some artificial limit)
% + inference (whose complexity we can easily determine)
...
by Earnest~\shortcite{30049}, and all other such complexities are inferred from
...
% TODO: The reference list should not include unpublished work. (earnest + OEIS + 3 corr references)
% TODO: replace all instances of {p} with \predicate (by hand)
