...
% TODO: read the formatting instructions and their LaTeX source (email font?)
% TODO: make sure there are no overflow errors
% TODO: maybe mention the term 'data complexity'
% TODO: make claim numbers subordinate to theorem numbers
% TODO: mention that most of the work for this paper was done at UoE
% TODO: the appendix should be in a separate file
% TODO: cite some works about synthesis
% TODO: clean up unnecessary things from the header (e.g., packages and definitions)
% TODO: don't use the '\in' syntax for predicates
% TODO: make sure I'm using \sigma instead of || everywhere
% TODO: (at the end): grammarly the whole thing, put the appendix in a separate file
\author{%
...
\begin{theorem}[Correctness of $\GDR$]
  ...
  $\phi \equiv \phi'$.
\end{theorem}
\begin{proof} % TODO: finish (Proof technique: if one is true then the other one will be true and vice versa)
