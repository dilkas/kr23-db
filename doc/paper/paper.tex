...
example FCG\@. Its source node has out-degree 1, label $\GDR$, and type $\GDR$.
% TODO: update the last sentence
...
\end{algorithm}
% TODO: have I introduced the GDR(v') syntax? (for other types as well)

\begin{itemize}
  \item TODO: define atomic --- no subtraction, i.e., just a variable name
