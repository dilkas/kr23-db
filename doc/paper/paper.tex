...
% TODO: add FastWFOMC (only for \FOtwo{})
...
\begin{proposition}[Correctness of $\CR$]
\end{proposition}
\begin{proof} % TODO: finish (Proof technique: if one is true then the other one will be true and vice versa)
  \[
    \forall X \in \Omega \ni x\text{. } X \ne x \implies \psi \equiv \forall X \in \Omega \setminus \{\, x \,\}\text{. } \psi
  \]
\end{proof}
...
\begin{proposition}[Correctness of $\Reff$]
\end{proposition}
