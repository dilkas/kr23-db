...
// vertex.
//
// NOTE: This visitor and other subsequently called visitors only traverse using
// non-GFODD edges because at this stage GFODD edges are not added to the graph
// yet.
...
private:
  ...
  HasseDiagram::Vertex source_vertex_, parent_of_target_;
};
